...
class CTrainer:
    ...
    def before_train(self):
        self.optimizer = optim.Adam(self.model.parameters(), lr=self.cfg.lr,weight_decay=5e-4)
...
class Trainer:
    ...
    def before_train(self):
        self.optimizer = optim.Adam(self.model.parameters(), lr=self.cfg.lr,weight_decay=0.01)
        self.criterion = nn.CrossEntropyLoss().to(self.cfg.device)
        self.early_stopping = EarlyStopping(self.logger, patience=self.cfg.patience)
